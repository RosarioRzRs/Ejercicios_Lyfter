class Student():
    def __init__(self, name, section, spanish_note, english_note, social_note, science_note, average_note):
        self.name = name
...
def add_information(list_of_students):
    ...
    for index in range (students_number_to_add):
        ...
        list_of_students.append(Student(student_name, section, spanish_note, english_note, social_note, science_note, average_note))
